...
export default function AddonItem({
  ...
  return (
    <div
      className={`w-[450px] h-[81px] border  rounded-lg flex items-center justify-between px-4 py-3 ${isActive ? 'bg-light-grey border-purple' : 'bg-white border-light-gray'}`}
    >
      <div className="w-full flex justify-between items-center gap-4">
        <div className="flex items-center gap-4">
          <input type="checkbox" className="w-5 h-5 accent-purple" onChange={onClick} checked={isActive} />
